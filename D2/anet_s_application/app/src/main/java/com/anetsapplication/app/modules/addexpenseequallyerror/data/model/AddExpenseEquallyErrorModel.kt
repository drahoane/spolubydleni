package com.anetsapplication.app.modules.addexpenseequallyerror.`data`.model

import com.anetsapplication.app.R
import com.anetsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class AddExpenseEquallyErrorModel(
  /**
  ...
  var txtSupportingtext: String? =
      MyApp.getInstance().resources.getString(R.string.msg_name_cannot_be)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtTimeZoneOne: String? = MyApp.getInstance().resources.getString(R.string.msg_cost_cannot_be)
  ,
  /**
   * TODO Replace with dynamic value
   */
